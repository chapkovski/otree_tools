...
class EnterEventList(PaginatedListView):
    ...
    paginate_by = 50
    navbar_active_tag = 'focus'
    export_link_name = 'enter_only_csv'


class EnterOnlyCSV(ListView):
    url_name = 'enter_only_csv'
    url_pattern = r'^enter_only_csv_export/$'
    template_name = 'otree_tools/enter_data.csv'
    context_object_name = 'enterevents'
    ...
    def render_to_response(self, context, **response_kwargs):
        ...
        r['Content-Disposition'] = 'attachment; filename="somefilename.csv"'
        return r
